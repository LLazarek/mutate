...
** DONE Split things into a neat private / public interface

** DONE Change mdo and friends to use keywords

** DONE Rename `-value-mutator` to `-constant-mutator`

** TODO Turn readme into docs
